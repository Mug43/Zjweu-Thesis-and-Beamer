...
% The lateset ZJWEU-Beamer-Theme is modified by Yining Bao.
% The source codes of this latex file for ZJWEU can be found here:
...
\usepackage{ZJWEU_beamer}

\author{包一宁\inst{1}}
\title{ZJWEU Beamer Theme}
\subtitle{学术汇报 Latex}
\institute{
  \inst{1}
  浙江水利水电学院 水利工程学院
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.35\linewidth]{pic/Zjweulogo.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}
    \begin{itemize}
        ...
        \item 这是清华大佬翁家翌在16-17年做的一些ppt：\href{https://github.com/Trinkle23897/oi_slides}{\color{purple}{戳我}}
    \end{itemize}
\end{frame}
...
\begin{frame}{作图}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.2\linewidth]{pic/Zjweulogo.png}
        \caption{校徽.png}
    \end{figure}
\end{frame}
...
\begin{frame}
    \begin{center}
        ...
        ~\\
        ~\\
        \textrm{\textsl{Email: baoyining1020@163.com}}
    \end{center}
\end{frame}
